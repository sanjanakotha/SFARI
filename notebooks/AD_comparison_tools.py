...
def compare_two_predictors(our_preds_df, other_preds_df, comp_list = pd.read_csv("../data/GSL.csv"), pred1_name = "Our Predictor", pred2_name = "Other Predictor", comp_list_name = "GSL"):
...
def unique_GSL_count(preds, GSL = pd.read_csv("../data/GSL.csv")):
    if type(preds) == str:
