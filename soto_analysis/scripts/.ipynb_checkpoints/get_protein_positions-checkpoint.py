...
# Get the name of the variants file
...
o_directory = "../outputs/mutations/cds_" + variants_filename_short + "_to_positions"
    ...
    if (".ipynb" not in file):
        ...
        with open(directory +  "/" + file) as f1, open(o_directory + "/" + file, "w") as o1:
            ...
            for line in f1:
                    ...
                    wt_aa = Seq(wt_str).translate()
                    # print(wt_aa)
                    # print(mt_aa)
                    
                    line.append(str(wt_aa))
                    line.append(str(aa_pos))
